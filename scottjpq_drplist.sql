...
--
-- Host: localhost:3306
-- Generation Time: Jun 27, 2021 at 06:35 PM
...
INSERT INTO `option_category` (`id`, `category`) VALUES
(1, 'Fashion');

-- --------------------------------------------------------

--
-- Table structure for table `option_location`
--
...
--
-- Dumping data for table `option_location`
--

INSERT INTO `option_location` (`id`, `state`, `town`) VALUES
...
(17, 'California', 'Anaheim'),
(18, 'California', 'Arden-Arcade'),
(19, 'California', 'Bakersfield'),
(20, 'California', 'Berkeley'),
(21, 'California', 'Burbank'),
(22, 'California', 'Carson'),
(23, 'California', 'Chula Vista'),
(24, 'California', 'Citrus Heights'),
(25, 'California', 'Compton'),
(26, 'California', 'Concord'),
(27, 'California', 'Corona'),
(28, 'California', 'Costa Mesa'),
(29, 'California', 'Daly City'),
(30, 'California', 'Downey'),
(31, 'California', 'East Los Angeles'),
(32, 'California', 'El Cajon'),
(33, 'California', 'El Monte'),
(34, 'California', 'Escondido'),
(35, 'California', 'Fairfield'),
(36, 'California', 'Fontana'),
(37, 'California', 'Fremont'),
(38, 'California', 'Fresno'),
(39, 'California', 'Fullerton'),
(40, 'California', 'Garden Grove'),
(41, 'California', 'Glendale'),
(42, 'California', 'Hayward'),
(43, 'California', 'Huntington Beach'),
(44, 'California', 'Inglewood'),
(45, 'California', 'Irvine'),
(46, 'California', 'Lancaster'),
(47, 'California', 'Long Beach'),
(48, 'California', 'Los Angeles'),
(49, 'California', 'Mission Viejo'),
(50, 'California', 'Modesto'),
(51, 'California', 'Moreno Valley'),
(52, 'California', 'Norwalk'),
(53, 'California', 'Oakland'),
(54, 'California', 'Oceanside'),
(55, 'California', 'Ontario'),
(56, 'California', 'Orange'),
(57, 'California', 'Oxnard'),
(58, 'California', 'Palmdale'),
(59, 'California', 'Pasedana'),
(60, 'California', 'Pomona'),
(61, 'California', 'Rancho Cucamonga'),
(62, 'California', 'Richmond'),
(63, 'California', 'Riverside'),
(64, 'California', 'Sacremento'),
(65, 'California', 'Salinas'),
(66, 'California', 'San Bernandino'),
(67, 'California', 'San Buenaventura'),
(68, 'California', 'San Diego'),
(69, 'California', 'San Franciso'),
(70, 'California', 'San Jose'),
(71, 'California', 'San Mateo'),
(72, 'California', 'Santa Ana'),
(73, 'California', 'Santa Clara'),
(74, 'California', 'Santa Clarita'),
(75, 'California', 'Santa Monica'),
(76, 'California', 'Santa Rosa'),
(77, 'California', 'Simi Valley'),
(78, 'California', 'Stockton'),
(79, 'California', 'Sunnyvale'),
(80, 'California', 'Thousand Oaks'),
(81, 'California', 'Torrance'),
(82, 'California', 'Vallejo'),
(83, 'California', 'Visalia'),
(84, 'California', 'West Covina');
...
INSERT INTO `payment` (`id`, `firstname`, `lastname`, `town`, `state`, `zipcode`, `telephone`, `payment_email`, `payment_type`, `payment_status`, `created_time`, `created_date`) VALUES
(2, 'Scott ', 'Nnaghor', 'Los Angeles', 'Carlifonia', '5566', '07368660611', 'scottmike275@gmail.com', 'CashApp', 'Approved', 1624658239, '2021-06-26 00:30:15');
...
INSERT INTO `posting` (`id`, `title`, `description`, `image`, `price`, `category`, `status`, `town`, `state`, `posted_by`, `created_time`, `created_date`) VALUES
(3, 'NEW-CREDIT-IDENTITY---JUST-START-ALL-OVER!', 'GET A NEW CREDIT IDENTITY AND JUST START ALL OVER IN ONE WEEK. RE-ESTABLISH YOUR CREDIT, REGAIN YOUR CREDIT IDENTITY AND GET FINANCING.', 'drplist1624706957.jpg', 25, 'Fashion', 'Pending', '5896', '1551', 'scottmike275@gmail.com', 1624832496, '2021-06-27 22:21:36'),
(4, 'Test', 'testing feature', 'drplist1624748754.jpg', 20, 'Fashion', 'Pending', '5828', '1531', 'scottmike275@gmail.com', 1624832419, '2021-06-27 22:20:19');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `email`, `password`, `role`, `status`, `telephone`, `address`, `zipcode`, `town`, `state`, `image`, `created_time`, `created_date`) VALUES
(1, 'Scott', 'Nnaghor', 'scottmike275@gmail.com', '$2a$08$Iy4F3Gxuyfhh/tIpgqtv0efuWnnjn.F/ibmPOXc8wTAiQYlkzmsBS', 'Admin', 'Active', '555 345 879', '56 Test Road, Warwick', '55567', '5724', '1525', 'drplist1624745338.jpg', 1624479968, '2021-06-23 20:26:08'),
(3, 'PRINCESS ', 'MONTICELLO', 'PERFECT850CREDIT@GMAIL.COM', '$2a$08$G62GqrldUN3p8R2YZv/iw.Wf767dx9ZXLjt3vViIRfRECvt52nwP.', 'Admin', 'Active', '000', 'none', '', '5723', '1548', 'original.jpg', 1624706712, '2021-06-26 11:25:12');
...
--
-- Indexes for table `option_location`
--
ALTER TABLE `option_location`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `option_location`
--
ALTER TABLE `option_location`
