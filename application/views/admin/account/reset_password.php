						...
						<div class="card">
							<div class="card-body">
								<div class="border p-4 rounded">
									...
									<div class="form-body">
										<form action="<?php echo base_url('admin/reset_password'); ?>" method="POST" class="row g-3">
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Reset Code</label>
												<div class="input-group" id="show_hide_password">
													<input type="text" name="code" class="form-control border-end-0" placeholder="Enter Password">
												</div>
											</div>
											
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">Enter Email Address</label>
												<div class="input-group" id="show_hide_password">
													<input type="email" name="email" class="form-control border-end-0" placeholder="Enter Password">
												</div>
											</div>
											...
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" name="reset" class="btn btn-light"><i class="bx bxs-lock-open"></i>Submit</button>
												</div>
											</div>
										</form>
										<?php
