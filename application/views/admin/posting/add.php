...
<head>
	...
	<title>Add Posting || Admin Dashboard</title>
</head>
			...
			<div class="page-content">
					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Add Posting</li>
							</ol>
						</nav>
					</div>
				</div>
              ...
              <div class="card">
				  <div class="card-body p-4">
					  <h5 class="card-title">Add Posting</h5>
					  <hr/>
                       <div class="form-body mt-4">
                        <form action="<?php echo base_url('admin/add_posting'); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
					    <div class="row">
						   <div class="col-lg-8">
							...
							<div class="border border-3 p-4 rounded">
                              <div class="row g-3">
								<div class="col-md-6">
								  ...
								  <div class="col-12">
									  <div class="d-grid">
                                         <button type="submit" name="btn_add" class="btn btn-light">Save</button>
									  </div>
								  </div>
							  </div> 
						  </div>
