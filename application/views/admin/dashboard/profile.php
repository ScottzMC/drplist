				...
				<div class="container">
					<div class="main-body">
						<div class="row">
							<div class="col-lg-4">
								<div class="card">
									<div class="card-body">
										...
										<?php 
										$query = $this->db->query("SELECT * FROM states WHERE state_id = '$user->state' ")->result();
										foreach($query as $qry){}
										
										$sequel = $this->db->query("SELECT * FROM cities WHERE city_id = '$user->town' ")->result();
										foreach($sequel as $sql){}
										?>
										<div class="d-flex flex-column align-items-center text-center">
											<img src="<?php echo base_url('uploads/profile/'.$user->image); ?>" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
											<div class="mt-3">
												<h4><?php echo $user->firstname; ?> <?php echo $user->lastname; ?></h4>
												<p class="mb-1"><?php echo $user->email; ?></p>
												<p class="font-size-sm"><?php echo $user->telephone; ?></p>
												<p class="font-size-sm"><?php echo $user->address; ?></p>
												<p class="font-size-sm"><?php echo $user->zipcode; ?></p>
												<?php if(!empty($sequel)){ ?>
												<p class="font-size-sm"><?php echo $sql->city_name; ?>,
												<?php }else{ echo ''; } ?>
												<?php if(!empty($query)){ ?>
												<?php echo $qry->state_name; ?>
												<?php }else{ echo ''; } ?>
												</p>
							...
							<div class="col-lg-8">
								<div class="card">
								    <form action="<?php echo base_url('admin/profile'); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8"> 
									<div class="card-body">
										<div class="row mb-3">
											<div class="col-sm-3">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="text" name="telephone" class="form-control" value="<?php echo $user->telephone; ?>" required />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="text" name="zipcode" class="form-control" value="<?php echo $user->zipcode; ?>" required />
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-sm-9">
												<input type="submit" name="save" class="btn btn-light px-4" value="Save Changes" />
											</div>
										</div>
									</div>
									</form>
								...
								<div class="card">
								    <form action="<?php echo base_url('admin/update_profile_image'); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8"> 
									<div class="card-body">
										<div class="row mb-3">
										    <div class="col-sm-3">
										...
										<div class="row">
											<div class="col-sm-3"></div>
											<div class="col-sm-9">
												<input type="submit" name="btn_image" class="btn btn-light px-4" value="Save Changes" />
											</div>
										</div>
									</div>
									</form>
