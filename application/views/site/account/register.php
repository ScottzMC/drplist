...
<html class="no-js">
    <head>
        <title>drplist - account register</title>
...
<section class="body">
    <div class="login-page-boxes">
        ...
        <div class="accountform login-box">
            <h1 class="accountform-banner">Register</h1>
            <form action="<?php echo base_url('account/register'); ?>" method="POST" class="loginform">
                ...
                <div class="accountform-actions">
                    <button type="submit" name="register" class="accountform-btn"><img src="<?php echo base_url('assets/images/drpslist-register-button.jpg'); ?>" height="40" /></button>
                    <a style="float: left; color: #000;" href="<?php echo site_url('account/login'); ?>" class="accountform-helplink-tiny" tabindex="-1">Already have an account?</a>
                </div>
                <?php
...
<footer>
    <ul class="clfooter">
        <li>&copy; 2021 <span class="desktop">drpslist</span><span class="mobile">DL</span></li>
