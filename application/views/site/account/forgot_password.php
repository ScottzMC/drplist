...
<html class="no-js">
    <head>
        <title>drplist - account forgot password</title>
...
<section class="body">
    <div class="login-page-boxes">
        ...
        <div class="accountform login-box">
            <h1 class="accountform-banner">Forgot Password</h1>
            <form action="<?php echo base_url('account/forgot_password'); ?>" method="POST" class="loginform">
                ...
                <div class="accountform-actions">
                    <button type="submit" name="forgot" class="accountform-btn"><img src="<?php echo base_url('assets/images/drpslist-submit-button.jpg'); ?>" height="40" /></button>
                </div>
            </form>
        </div>
